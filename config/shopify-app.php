...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products, write_products, write_script_tags, read_orders, write_orders, read_shipping,write_shipping, read_fulfillments, write_fulfillments, read_customers, write_customers, read_locations'),
    ...
    */
    ...
    'webhooks' => [
        ...
        //     'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://shipping-express.chainpulse.tech/webhook/orders-create')
        // ],
        // [
        //     'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'FULFILLMENTS_CREATE'),
