...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string("courier_id")->nullable(true);
            ...
            $table->string("courier_vehicle_id")->nullable(true);
            $table->string("courier_transport_mode")->nullable(true);
            ...
            $table->string("picked_up_at")->nullable(true);
