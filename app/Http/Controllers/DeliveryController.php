...
class DeliveryController extends Controller
{
    ...
    //         CURLOPT_URL => 'https://162c3cab6824910a19967e6368443603:shpua_de1d67b8a3a7cff9e0183b7951d9bf21@shipping-courier.myshopify.com/admin/api/2023-07/orders.json',
    ...
    public function add_shipping_rates(Request $request)
    {
        ...
        curl_setopt_array($curl1, array(
            ...
            CURLOPT_URL => 'https://qwqer.hostcream.eu/api/v1/clients/auth/trading-points/3/delivery-orders/get-price',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    public function create_order(Request $request)
    {
        ...
        $url = $data ['order_status_url'];

        $new_url = explode('/',$url);

        $domain = $new_url[2];

        // $user_id = User::where('name', $domain)->get([id]);
